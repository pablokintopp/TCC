...
public class Main {
	...
	public static String URL_DESPESAS = CURRENT_DIRECTORY+"/dados/INPUT/despesas.csv";	
	public static String OUTPUT_PATH = CURRENT_DIRECTORY+"/dados/OUTPUT/";
	public static String ELKI_RESULTS = CURRENT_DIRECTORY+"/dados/OUTPUT_ELKI/";
	public static String INPUT_PATH = CURRENT_DIRECTORY+"/dados/INPUT/";
	...
	public static void main(String[] args) throws IOException {
		...
		OUTPUT_PATH+=folder;
		ELKI_RESULTS+=folder;
		boolean isAno = args[2].equals("ano");
		String ano = args[3];
		String anoEnd ="";
		...
		boolean isLastStep = args[4].equals("last");
		String originalFile = args[5];
		 //LENDO DESPESAS
	...
	if(isAno){
		...
		if(!isLastStep){
			...
			anos.get(0).print(Ano.VALOR_RELATIVO_NORMALIZADO,printExpenditureTOtal,
					useCode,printName,minCategory, hasHeader, df, printScores, OUTPUT_PATH +"_REL_NOR.csv");	
	    	anos.get(0).print(Ano.VALOR_SUAVIZADO_NORMALIZADO,printExpenditureTOtal,
	    			useCode,printName,minCategory, hasHeader, df, printScores, OUTPUT_PATH +"_SUA_NOR.csv");	
			...
			//LENDO SCORES	
				...
				reader.readScores(anos.get(0), ELKI_RESULTS+"ELKI_REL_NOR.txt","REL_NOR");			
				reader.readScores(anos.get(0), ELKI_RESULTS+"ELKI_SUA_NOR.txt","SUA_NOR");		
				boolean useCode = true;
				boolean minCategory = true;
				boolean hasHeader = true; 
				...
				anos.get(0).print(Ano.VALOR_ABSOLUTO,printExpenditureTOtal,useCode,printName,
						minCategory, hasHeader, df, printScores, OUTPUT_PATH +"_SCORED.csv");
		}		
