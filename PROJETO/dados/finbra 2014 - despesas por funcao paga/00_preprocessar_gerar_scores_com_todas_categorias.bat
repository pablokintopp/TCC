...
:::: Preprocessamento --centroid vizinhos colPopulacao colId colStart-colEnd colLOF minLOF maxGoodLOF  < %FILE%> scores_percents.csv
::java Preprocessamento --centroid 20 3 1 4-33 37 1.5 1.19   < %FILE% > anomalies_suav.csv
::java Preprocessamento --centroid 20 3 1 4-33 39 1.5 1.19  < %FILE% > anomalies_rel.csv
